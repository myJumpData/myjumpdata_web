...
export default function TermsScreen() {
  ...
  function Main() {
    return (
      <div>
        <TermsSection heading="Terms of Use">
          <TermsText>
            The myJumpData website located at myjumpdata.fediv.me is a
            copyrighted work belonging to myJumpData. Certain features of the
        ...
        <TermsSection heading="Access to the Site">
          <TermsText>
        ...
        <TermsSection heading="User Content">
          ...
          <TermsText>
            ...
            Content, terminating your Account in accordance with TermsSection 8,
        ...
        <TermsSection heading="Third-Party Links & Ads; Other Users">
          <TermsText>
        ...
        <TermsSection heading="Disclaimers">
          <TermsText>
        ...
        <TermsSection heading="Limitation on Liability">
          <TermsText>
          ...
          <TermsText>
            <strong>Term and Termination.</strong> Subject to this TermsSection,
            ...
            Terms will remain in effect: Sections 2 through 2.5, TermsSection 3
            and Sections 4 through 10.
          </TermsText>
        </TermsSection>
        <TermsSection heading="Copyright Policy">
          <TermsText>
        ...
        <TermsSection heading="General">
          ...
          <TermsText>
            ...
            Notice to the Company should be sent to: myJumpData@gmail.com .
          ...
          <TermsText>
            Company is located at the address in TermsSection 10.8. If you are a
        ...
        <TermsSection heading="Contact Information">
          <TermsText>Email: myjumpdata@gmail.com</TermsText>
        </TermsSection>
      </div>
    );
  }
...
export function TermsSection({
  ...
  return (
    <div className="mx-auto max-w-prose">
      ...
      <div className="break-normal text-justify">{children}</div>
    </div>
  );
}
